(function(){
  const fixes={
    ...
    J015:{role:"Client Services Officer / Bookkeeper (Part-Time, 4–5 Days per Week)",status:"🔵 Applied",applied_date:"4 Sep 2026",application_evidence:"Direct application email sent to Graham Downs with resume and cover letter",closing:"Open / still surfaced as current on 5 Sep 2026",career:"High — verified current part-time accounting-firm bookkeeping/client-services role in Rivervale. Strong public-practice exposure, but prior bookkeeping experience remains an important selection factor.",verified_date:"5 Sep 2026"},
    J029:{status:"🚫 Disregarded",criteria_excluded:true,criteria_excluded_reason:"Duplicate tracker entry",disregarded_reason:"Duplicate of J100, which is the retained current record for the same DTWD Accounts Processing Officer / Accounts Officer / Finance Officer Talent Register.",career:"Duplicate historical tracker row retained for stable-ID/history purposes. J100 is the authoritative active record for this exact DTWD talent register and contains the corrected current Level 2 pay information.",verified_date:"6 Sep 2026"},
